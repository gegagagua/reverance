...
import { WHATSAPP_HREF } from './mobile-dock.content'

// Official WhatsApp glyph (single path, currentColor) so the floating button is
// instantly recognisable — no icon dependency, inlined to stay first-paint free.
const WHATSAPP_ICON =
...
/**
 * Always-available floating WhatsApp button. Fixed to the viewport corner at any
 * scroll position; a single click opens WhatsApp directly. The click is tracked
 * as a conversion.
 */
